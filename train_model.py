...
# parts.
training_xml_path = 'HELEN.xml'
test_xml_path = 'IBUG.xml'
t1 = time.clock()
print('Training...')
dlib.train_shape_predictor(training_xml_path, 'model/predictor_helen.dat', options)
...
print("\nAccuracy: {}".format(
    dlib.test_shape_predictor(test_xml_path, 'model/predictor_helen.dat')))
